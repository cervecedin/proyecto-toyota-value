    ...
    <body className="my-5 gradient-form" style={{minHeight:'100%',position:'relative'}}>
        <div >
          <div className="d-flex flex-column ms-5" style={{ justifyContent:'center', textAlign:'center', margin:'0 auto'}}>
            <h1 style={{fontSize:'50px',color:'#d8363a',fontFamily:'Lato',fontWeight:'bold'}}>Toyota VALUE</h1>
            ...
            <div className="text-center pt-1 mb-5 pb-1">
              <button style={{borderStyle:'solid',borderWidth:'2px', color:'white', padding:'7px',backgroundColor:'#d8363a',marginTop:'10px'}}>
            ...
            <div className="pb-4 mb-4" style={{textAlign:'center'}}>
              ...
              <button  style={{borderStyle:'solid',borderWidth:'2px', color:'white', padding:'7px',backgroundColor:'#d8363a'}}>
                Crear
              </button>
            </div>
